...
const THEMES = {
    default: {
        ...
        accent: '#3daee9',
        text: '#eee',
        particleColor: '#3daee9'
    },
    cyberpunk: {
        name: 'Cyberpunk',
        bg: '#0d0221',
        cardBg: 'rgba(13, 2, 33, 0.8)',
        accent: '#ff006e',
        text: '#00f5ff',
...
const UserProfile = () => {
    ...
    return (
        <div ref={scrollRef} className="user-profile-app" style={{
            ...
            {/* Theme Switcher - Positioned just below window controls */}
            <div style={{
                position: 'fixed',
                top: '50px',
                left: '20px',
                ...
                {Object.keys(THEMES).map(key => (
                    <button
                        ...
                        style={{
                            ...
                            height: '30px',
                            borderRadius: '50%',
                            border: osTheme === key ? `3px solid ${THEMES[key].accent}` : '2px solid rgba(255,255,255,0.2)',
            ...
            <div className="hero-banner" style={{
                height: '220px',
                background: `linear-gradient(45deg, ${currentTheme.bg}, ${currentTheme.accent}30)`,
                    ...
                    <div className="glass-panel" style={{
                        ...
                        <button
                            ...
                            style={{
                                width: '100%',
                                padding: '15px',
                                background: downloadingResume ? '#666' : `linear-gradient(135deg, #2ecc71, #27ae60)`,
                                color: 'white',
                                border: 'none',
                                borderRadius: '8px',
                                ...
                                marginTop: '20px',
                                transition: 'all 0.2s',
                                boxShadow: downloadingResume ? 'none' : '0 4px 15px rgba(46, 204, 113, 0.3)',
